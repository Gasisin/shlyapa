...
public class TeamManager{
    ...
    public ArrayList<GameUser> getTotalUsers(){
        return _totalUsers;
    }
    public boolean isFullTeam(){
        if (_addedUser.size()%2==0&&_addedUser.size()!=2&&_addedUser.size()!=0){return true;}
        return false;
    }
    ...
    public ArrayList<Team> refreshAndGetTeams(){
    ...
    public GameUser getLastAddedUser() {
        return _addedUser.get(_addedUser.size()-1);
    }
}
